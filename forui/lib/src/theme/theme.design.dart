...
mixin _$FThemeMotionFunctions on Diagnosticable implements FThemeMotionDelta {
  /// Returns itself.
  @override
...
///
/// A [FThemeMotion] is itself a [FThemeMotionDelta].
abstract class FThemeMotionDelta with Delta {
  ...
  /// Creates a delta that returns the [FThemeMotion] in the current context.
  const factory FThemeMotionDelta.context() = _FThemeMotionContext;

  @override
  FThemeMotion call(covariant FThemeMotion value);
}

class _FThemeMotionDelta implements FThemeMotionDelta {
  const _FThemeMotionDelta({this.duration, this.curve});
...
class _FThemeMotionContext implements FThemeMotionDelta {
  const _FThemeMotionContext();

  @override
  FThemeMotion call(FThemeMotion original) => original;
}
